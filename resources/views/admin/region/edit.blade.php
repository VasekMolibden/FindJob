...
@section('main')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактирование региона: {{ $region['region'] }}</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @include('messages')
        </div><!-- /.container-fluid -->
                        ...
                        <form action="{{ route('region.update', $region['id']) }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $region['region'] }}" name="region" class="form-control"
                                        id="region" placeholder="Введите название региона" required>
                                </div>
                            </div>
                            <!-- /.card-body -->
